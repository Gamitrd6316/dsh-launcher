...
Установка dsh обычно требует установки Node.js, команд npm и настройки реестров; обновление — поиска команд; плагины — ручного `git pull`. **Слишком много хлопот.** Этот лаунчер — **дружелюбный менеджер dsh для новичков**, упаковавший всё в один exe:

- 🎯 **Детект окружения + установка в один клик**：нет Node.js — установит сам (свой путь), dsh — один клик
- 🔄 **Обслуживание в один клик**：обновление dsh, всех плагинов и починка зависимостей вместе
- 🧩 **Визуальное управление плагинами**：выбор в магазине, авто-починка зависимостей, изоляция сломанных плагинов
- 🖥️ **Готов к работе**：двойной клик → «Запуск» → браузер открывается. Без командной строки
